class TarefasController < ApplicationController
  ...
  # GET /tarefas/new
  def new
    @tarefa = Tarefa.new# apenas instancia novo obj para posteriormente salvar no bd 
  ...
  def destroy
    @tarefa.destroy
    respond_to do |format|
      format.html { redirect_to tarefas_url, notice: "Tarefa excluida com sucesso." }
  ...
  private
    ...
    def set_tarefa# é chamado antes da execução do destroy *(excluir um regtistro)!!!! 09/09/2021
